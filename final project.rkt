...
;;;;  Glen Anderson
;;;   May 2, 2014
;;    Slow Stochastic, MACD, and EMA formulas from stockcharts.com
...
;(plot (lines  vecti ))
;(plot (points (map flatten closing-indexed )))
;(plot (discrete-histogram (map flatten closing-pairs)))

;;takes: a list of lists, in each list is an index in the car and price in the cdr, index to stop at and initial value (0)
;;returns: sum of all prices in the list, up until and including last-day
